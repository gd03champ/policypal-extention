...
7. To analyze a TOS or privacy policy page:
   ...
   - Select the "[PolicyPal✨] - Inspect Policy" option from the context menu or clikcing the extention icon top open popup. It's like having a secret detective tool! 🕵️‍♂️<br>
